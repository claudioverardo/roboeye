...
%   See also GENERATE_TRAJECTORY, GET_TARGET, GET_TARGET_FROM_VISION
    ...
    fprintf('   MAXPOINTS = %d\n', MAXPOINTS);
    home_position = double(read(s,QNUM,'uint8'));
    ...
    while ~exit
        ...
        switch state
            ...
            case STATE{4} % READY
                ...
                current_position = double(read(s,QNUM,'uint8'));
                    ...
                    switch cmd
                        ...
                        case 1 % back home
                            [trajectory, time_trajectory, confirm] = generate_trajectory( ...
                                'back-home', home_position, current_position, DELTA_T_KEYPOINTS_TRAJECTORY, ...
                        ...
                        case 3 % move joints
                            [trajectory, time_trajectory, confirm] = generate_trajectory( ...
                                'move-q', home_position, current_position, DELTA_T_KEYPOINTS_TRAJECTORY, ...
                                [], [], trajectory_planning_args, [], fn_robot_input ...
                            );
                            data_tx = trajectory2serialdata('keypoints', DELTA_T_KEYPOINTS_TRAJECTORY, trajectory);
                            fprintf('\n');
                        ...
                        case 4 % move to n points
                            [trajectory, time_trajectory, confirm] = generate_trajectory( ...
                                'move-t-npoints', home_position, current_position, DELTA_T_KEYPOINTS_TRAJECTORY, ...
                        ...
                        case 5 % move to target (pointwise trajectory)
                            if ~all(current_position == home_position)
                                ...
                                [trajectory, time_trajectory, confirm] = generate_trajectory( ...
                                    'move-t-pointwise', home_position, current_position, DELTA_T_POINTWISE_TRAJECTORY, ...
                        ...
                        case 6 % move to target (keypoints trajectory)
                            [trajectory, time_trajectory, confirm] = generate_trajectory( ...
                                'move-t', home_position, current_position, DELTA_T_KEYPOINTS_TRAJECTORY, ...
                                cam, vision_args, trajectory_planning_args, fn_cam2robot_coords, fn_robot_input ...
                            );
                            data_tx = trajectory2serialdata('keypoints', DELTA_T_KEYPOINTS_TRAJECTORY, trajectory);
                            fprintf('\n');
                        ...
                        case 7 % pick/place object (keypoints trajectory)
                            [trajectory, time_trajectory, confirm] = generate_trajectory( ...
                                'grasp', home_position, current_position, DELTA_T_KEYPOINTS_TRAJECTORY, ...
                                cam, vision_args, trajectory_planning_args, fn_cam2robot_coords, fn_robot_input ...
                            );
                            data_tx = trajectory2serialdata('keypoints', DELTA_T_KEYPOINTS_TRAJECTORY, trajectory);
                            fprintf('\n');
                        ...
                        case 8 % pick/place object (keypoints trajectory + parabola)
                            [trajectory, time_trajectory, confirm] = generate_trajectory( ...
                                'grasp-parabola', home_position, current_position, DELTA_T_KEYPOINTS_TRAJECTORY, ...
                                cam, vision_args, trajectory_planning_args, fn_cam2robot_coords, fn_robot_input ...
                            );
                            data_tx = trajectory2serialdata('keypoints', DELTA_T_KEYPOINTS_TRAJECTORY, trajectory);
                            fprintf('\n');
