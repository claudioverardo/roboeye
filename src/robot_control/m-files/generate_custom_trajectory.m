function [trajectory, confirm] = generate_custom_trajectory(current_position, home_position, cam, vision_args, fn_cam2robot_coords, fn_robot_input)
...
%   See also TODO
    ...
    if ~all(current_position == home_position)
        fprintf('ERROR: robot must be home position!!\n');
        confirm = 0;
        trajectory = [];
