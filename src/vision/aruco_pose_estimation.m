function [rois, i_arucos, rois_R, rois_t] = aruco_pose_estimation(img, aruco_markers, aruco_real_sides, K, varargin)
...
%   See also ARUCO_DETECTION, ROI_POSE_ESTIMATION
    ...
    [rois_R, rois_t] = roi_pose_estimation(img, rois, i_arucos, aruco_real_sides, K, 'verbose', ROI_POSE_ESTIMATION_VERBOSE);
